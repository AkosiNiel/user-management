...
<body>
    <div class="edit-container">
        ...
        <form method="POST" action="{{ Auth::user()->role === 'superadmin' ? route('users.update', $user->id) : route('profile.update') }}">
            @csrf
            @method('PUT')
            ...
            <label>Middle Name:</label>
            <input type="text" name="middlename" value="{{ old('middlename', optional($user->profile)->middlename) }}">
            ...
            <button type="submit" onclick="return confirm('Are you sure you want to update this profile?')">Update</button>
        </form>
    </div>
</body>
</html>
